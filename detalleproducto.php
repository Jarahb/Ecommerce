...
$queryProducto = "SELECT id,nombre,precio,existencias FROM productos where id='$id'; ";
...
<div class="card card-solid">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-12 col-sm-6">
                <h3 class="my-3"><?php echo utf8_encode($rowProducto['nombre']) ?></h3>
                <p>Quiero poner una descripcion AQUI</p>
                ...
                <h4 class="mt-3">Tallas
                    <small>Por favor seleccione una:</small>
                </h4>
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-default text-center">
                ...
                <h4>Existencias: <?php echo $rowProducto['existencias'] ?></h4>

                <div class="bg-gray py-2 px-3 mt-4">
                    <h2 class="mb-0">
                        <?=numfmt_format_currency($fmt,  $rowProducto['precio'], "EUR")."\n"; ?>
                    </h2>
                </div>
