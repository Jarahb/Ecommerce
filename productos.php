    ...
    <?php foreach ($infoProducto as $producto): ?>
        <div class="col-lg-4 col-md-6 col-sm-12">
            <div class="card border-primary">
                <img class="card-img-top img-thumbnail productos" src="<?= $producto['web_path'] ?>" alt="">
        ...
        <ul class="pagination">
            ...
            if ($paginaSel != 1) {
                ...
                <li class="page-item <?= $paginaSel != 1 ?? "disabled"?>">
                    <a class="page-link" href="index1.php?modulo=productos&pagina=<?php echo($paginaSel - 1); ?>"
                       aria-label="Previous">
            ...
            for ($i = 1; $i <= $totalPaginas; $i++) {
                ...
                <li class="page-item <?php echo ($paginaSel == $i) ? " active " : " "; ?>">
                    <a class="page-link"
                       href="index1.php?modulo=productos&pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
                <?php
            }
            ?>
